        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ValorMinimoCompra = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Entrega_Logradouro = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    Entrega_Numero = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    Entrega_Complemento = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    Entrega_Bairro = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Entrega_Cidade = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Entrega_Estado = table.Column<string>(type: "nvarchar(2)", maxLength: 2, nullable: false),
                    Entrega_Cep = table.Column<string>(type: "nvarchar(8)", maxLength: 8, nullable: false),
                    Entrega_Pais = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: false),
                    Status = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    Subtotal = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    DescontoCupom = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ValorFrete = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Total = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    CupomAplicadoId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TipoRoupa = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    Material = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    TipoPisada = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    IndicacaoUso = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    CriadoEm = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VariacaoProdutoId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TokenTransacaoExterna = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    CriadoEm = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Estoques_VariacoesProduto_VariacaoProdutoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Estoques_VariacaoProdutoId",
                table: "Estoques",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VariacoesProduto_ProdutoId",
                table: "VariacoesProduto",
                column: "ProdutoId");

            migrationBuilder.CreateIndex(
                name: "IX_VariacoesProduto_Sku",
                table: "VariacoesProduto",
                column: "Sku",
                unique: true);
        }
